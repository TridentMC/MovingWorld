...
public class MovingWorldCoreMod implements IFMLLoadingPlugin {
    ...
    public String getModContainerClass() {
        return "darkevilmac.movingworld.common.asm.coremod.MovingWorldModContainer";
    }
    ...
    public String getAccessTransformerClass() {
        return "darkevilmac.movingworld.common.asm.coremod.MovingWorldAccessTransformer";
    }
